...
class SiglipVisionEmbeddings(nn.Module):
    ...
    def forward(self, pixel_values: torch.FloatTensor) -> torch.Tensor:
        ...
        # the shape changes from [b, c, h, w] to [b, embed_dim, num_patches_w, num_patches_h]
...
class SiglipAttention(nn.Module):
    def __init__(self, config):
        ...
        self.scale = self.head_sim **-0.5 #This is the 1/sqrt(d) term in (QTK)V/sqrt(D)
    ...
    def forward(self, hidden_states):
        ...
        #attn weight shape: [batch_size, num_heads, num_patches, num_patches]
